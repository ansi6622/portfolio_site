    ...
    .then(function () {
      return Promise.all([
        ...
        knex('projects').insert({
          ...
          image_link: 'http://www.placecage.com/gif/199/300'
        }),
        knex('projects').insert({
          name: 'trender.io',
          ...
          image_link: 'http://www.placecage.com/gif/200/301'
        }),
        knex('projects').insert({
          name: 'Stocker',
          ...
          image_link: 'http://www.placecage.com/gif/199/301'
        }),
        knex('projects').insert({
          name: 'GeoCatch',
          ...
          image_link: 'http://www.placecage.com/gif/200/302'
        }),
      ]);
    });
};
